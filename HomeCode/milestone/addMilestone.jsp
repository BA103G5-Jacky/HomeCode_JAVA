...
<div class="">
	...
	<div class="container Portfolio">
		<h1>案件成立流程</h1>
			<span style="font-size:20px; color:red;">新增合約進度里程</span> >> 信用卡付款
	</div> 	
		...
		<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/milestone/milestone.do" name="form1">
			...
			<div class="container Portfolio mrg-top-15 mrg-bottom-15">
				<div class="row mrg-top-15">
					...
					<!-- magic button   ============================================================= -->
					<button  type="button" onclick="inputInfo1()">一</button>
					<button  type="button" onclick="inputInfo2()">二</button>
					<button  type="button" onclick="inputInfo3()">三</button>
					<!-- magic button   ============================================================= -->
				</div>
...
<!-- footer-end   ============================================================= -->
		...
		<script>
				function inputInfo1(){
				      ...
				      document.getElementById("milestoneName").value="前端功能";
				      document.getElementById("startDate").value="10/19/2017";
				      document.getElementById("endDate").value="10/31/2017";
				...
				function inputInfo2(){
				      ...
				      document.getElementById("milestoneName").value="後端功能";
				      document.getElementById("startDate").value="10/31/2017";
				      document.getElementById("endDate").value="11/31/2017";
		
				    }
				function inputInfo3(){
		
				   	  document.getElementById("milestoneName").value="手機端";
				      document.getElementById("startDate").value="12/01/2018";
				      document.getElementById("endDate").value="12/31/2018";
				    }
		</script>		
		<!-- magic button   ============================================================= -->
	</body>
