...
<!-- 												<select> -->
	...
	<%-- 														<option value="${stVO.skillNo}">${stVO.skillName}</option> --%>
...
function inputInfo1(){
    ...
    document.getElementsByName("csName")[0].value="天才衝衝衝人才菁英招募網站";
    ...
    document.getElementsByName("csPayment")[0].value="150";
    document.getElementsByName("csLevel")[2].checked="checked";
    $("#startDate").val("10/15/2017");
    $("#endDate").val("12/31/2017");
  }
