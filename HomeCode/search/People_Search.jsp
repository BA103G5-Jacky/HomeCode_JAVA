...
if(session.getAttribute("listPeople_ByCompositeQuery") == null || request.getQueryString() == null){
...
<%-- 														<c:if test="${i.count%4 == 0}"><br></c:if> --%>
									...
									<div class="central">
										...
										<!-- magic button -->
										<button type="button" class="btn btn-default" style="background-color: #eee; color: white;" onclick="inputInfo4();">前</button>
									</div>
						...
						<c:choose>
							...
							<c:otherwise>
								<div class="align-content">
									<a href="<%=request.getContextPath()%>/login/vistor_login.jsp" class="green" style="font-size:26px;">聯絡會員前<br>請先登入</a>
								</div>
							</c:otherwise>
						</c:choose>
					</div>
...
<div class="col-xs-12 col-sm-10 col-sm-offset-1 content-all central">
	...
	<!-- footer-end   ============================================================= -->
			...
			function inputInfo4(){
				...
				document.getElementsByName("mbName")[0].value="前端";
			}
