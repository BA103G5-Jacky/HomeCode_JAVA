...
<!-- ============================================================================feedback========================================================================-->
	...
	<div class="container margin-top-bottom cen">
		...
		<div class=" mrg-top-15  col-xs-12  ">
			...
			<!-- magic button   ============================================================= -->	
						<div class="img-va central" style="margin:10px;">
							<button  onclick="inputInfo1()">Shari</button>
							<button  onclick="inputInfo2()">Shari</button>
						</div>
...
<script>
function inputInfo1(){
document.getElementsByName("reportReason")[2].checked="checked";
document.getElementsByName("reportDesc") [0].value="訊息涉及性騷擾";
}
function inputInfo2(){
	document.getElementsByName("reportReason")[5].checked="checked";
	document.getElementsByName("reportDesc") [0].value="這照片看起來很像演藝人員的照片，感覺就是盜用照片";
	}
</script>
