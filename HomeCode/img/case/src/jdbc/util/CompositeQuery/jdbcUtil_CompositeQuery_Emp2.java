...
public class jdbcUtil_CompositeQuery_Emp2 {
	...
	public static String get_aCondition_For_Oracle(String columnName, String value) {
		...
		else if ("ename".equals(columnName) || "job".equals(columnName)) // varchar
			
			aCondition = columnName + " like '%" + value + "%'";
		
		else if ("hiredate".equals(columnName))                          // date
	...
	public static void main(String argv[]) {
		...
		//  req.getParameterMap()��k �^�� java.util.Map<java.lang.String,java.lang.String[]> 
		...
		map.put("action", new String[] { "getXXX" }); // Mapactionkey
