...
<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<ul class="nav navbar-nav">
					<li class="dropdown"><a href="#" class="collapse-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="<%=request.getContextPath()%>/favoriteCase/favoriteCase.do?mbNo=${mbNo}&action=favoriteCaseList">收藏案件</a></li>
				...
				<form class="navbar-form navbar-left ng-pristine margin01" method="post" 
					action="<%=request.getContextPath()%>/search/SearchServlet" id="searchForm">
					<div class="input-group">
						<div class="dropdown input-group-btn collapse-toggle">
							...
							<ul class="dropdown-menu">
								<li><a href="javascript:searchCase();">尋找案件</a></li>
								<li><a href="javascript:searchPeople();">尋找人才</a></li>
							</ul>
						</div>
						<input type="hidden" id="searchInput" name="action" value="listCases_ByCompositeQuery">
						<input type="text" id="fc-input" class="form-control" name="searchInput" placeholder=" 找工作案件" onkeypress="submitForm(event);">
					</div>
				</form>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu">
								<li><a href="<%=request.getContextPath()%>/green/Introduce.jsp?tab=1">如何接案</a></li>
								<li><a href="<%=request.getContextPath()%>/green/Introduce.jsp?tab=2">如何發案</a></li>
								<li><a href="#custMsg" data-toggle="modal" onclick="resetModal();">客服中心</a></li>
								<li><a href="<%=request.getContextPath()%>/green/Introduce.jsp?tab=3">合約範本下載</a></li>
							</ul></li>
					</ul>
...
<script>
	function inputInfo4(){
		$('#cusMesgTopic').val('想請問你們怎麼抽成');
		$('#cusMesgContent').val('安安你好，我是新用你們網站的會員，想請問你們怎麼抽成的呢?阿怎麼給我錢');
	}
